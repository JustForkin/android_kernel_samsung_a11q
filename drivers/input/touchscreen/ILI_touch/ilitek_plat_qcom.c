...
unsigned char CTPM_FW_TM_ILI7807G[] = {
	#include "firmware/SMS1871_TM_639_LongH_V0x2D.0x08.0x00_AP_0x03.0x00_MP_20200214.ili"
};

unsigned char CTPM_FW_TXD_ILI7807G[] = {
	#include "firmware/SMS1871_TXD_639_LongH_V0xCD.0x0F.0x00_AP_0x04.0x00_MP_20200226.ili"
};
