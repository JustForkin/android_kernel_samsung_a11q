...
/* RegStat0  */
#define SX932x_PROXSTAT_PH3_FLAG    0x88 //enable 2-level trigger
#define SX932x_PROXSTAT_PH2_FLAG    0x44 //enable 2-level trigger
#define SX932x_PROXSTAT_PH1_FLAG    0x22 //enable 2-level trigger
#define SX932x_PROXSTAT_PH0_FLAG    0x11 //enable 2-level trigger
...
static struct smtc_reg_data sx932x_i2c_reg_setup[] = {
    ...
    },
    {
        ...
        .val = 0x0B,       // Digital Gain(ph2/3) : off(001) Digital Filter(ph2/3) : 1-1/2(001)
    },
    {
    ...
    },
    {
        ...
        .val = 0x18,       // Prox Theshold(ph0/1) : 684
    },
    {
        .reg = SX932x_PROX_CTRL7_REG,  //0x37
        .val = 0x15,       // Prox Theshold(ph2/3) : 684
    },
...
struct sx93XX
{
    ...
    /*
     * Since we are trying to avoid knowing the registers,
     * we create a pointer to the general read register
     * that will read the interrupt source
     */
    ...
    /*
     * whether irq should be ignored.. cases if enable/disable irq
     * is not usedor does not work properly
     */
    char irq_disabled;
